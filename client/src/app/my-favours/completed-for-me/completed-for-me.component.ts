...
import { CompletedForMeCardComponent } from "./completed-for-me-card/completed-for-me-card.component";

@Component({
  selector: 'app-completed-for-me',
  imports: [MatPaginatorModule, AsyncPipe, MatDivider, CompletedForMeCardComponent],
  templateUrl: './completed-for-me.component.html',
  styleUrl: './completed-for-me.component.scss',

})
export class CompletedForMeComponent {
  ...
  readonly menuItems$ = combineLatest([
    ...
    switchMap(([searchTerm, currentPage]) =>
      this.favourService.favoursCompletedByOthers(searchTerm, currentPage)
    )
  );
